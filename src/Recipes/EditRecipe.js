...
const EditRecipe = props => {
    ...
    return <div className="EditRecipe">
        <Grid>
            ...
            <Grid.Column>
                <Input key='name' value={props.recipe ? props.recipe.name : ""}
                       onChange={(e) => props.updateState("name", e.target.value)}/><br/>
            </Grid.Column>
        </Grid>
        <Grid>
            <Grid.Column>
            ...
            <Grid.Column>
                <TextArea key='description' value={props.recipe ? props.recipe.description : ""}
